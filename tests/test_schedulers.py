...
@pytest.mark.parametrize('scheduler_name', os.listdir(path + '/scheduler'))
def test_schedulers(scheduler_name: str, path: str = path) -> None:
    scheduler_name = scheduler_name.split('.')[0]
